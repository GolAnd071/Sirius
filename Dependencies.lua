...
IncludeDir["filewatch"] = "%{wks.location}/Sirius/vendor/filewatch"
...
IncludeDir["mono"] = "%{wks.location}/Sirius/vendor/mono/include"
...
LibraryDir["mono"] = "%{wks.location}/Sirius/vendor/mono/lib/%{cfg.buildcfg}"
